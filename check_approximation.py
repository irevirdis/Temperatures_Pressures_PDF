...
res = poly_approx(pc[:,0], pc[:,1], pc[:,2], pc[:,3])
myPolyint.computeCoefficients(res)
#np.set_printoptions(threshold=np.nan)

#print 'the dimension of res are:', res.shape
...
print 'the list of orders is:', order_info
print 'order of the polynomial approximation:', max(np.array([order_info])) # to correct!
print '---------------------------'
